...
public class SystemWebViewClient extends WebViewClient {
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        ...
        event.status = LoadingEvent.Started;
        EventBus.getDefault().post(event);*/
        //Toast.makeText(view.getContext(),"正在拼命加载中,请稍等...",Toast.LENGTH_SHORT).show();
    }
    ...
    public void onPageFinished(WebView view, String url) {
       ...
       /* LoadingEvent event = new LoadingEvent();
        event.status = LoadingEvent.Finished;
        EventBus.getDefault().post(event);*/
       // Toast.makeText(view.getContext(),"正在拼命加载中,请稍等...",1).show();
    }
    ...
    public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
       ...
       /* LoadingEvent event = new LoadingEvent();
        event.status = LoadingEvent.Error;
        EventBus.getDefault().post(event);*/
    }
